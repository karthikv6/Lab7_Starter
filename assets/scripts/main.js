...
async function getRecipes() {
  ...
  // if(typeof(localStorage.getItem("recipes")) !='undefined'){
  ...
  return new Promise(async function(resolve, reject) {
    resolve(await collectRecipes(recipes))
  });
...
const collectRecipes = async() => {
    try {
      ...
      recipe = window.localStorage.getItem('recipes')
      return recipes;
...
// async function collectRecipes(recipes){
